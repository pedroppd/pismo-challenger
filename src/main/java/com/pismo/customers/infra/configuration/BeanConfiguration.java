...
public class BeanConfiguration {
    ...
    @Bean
    public TransferServiceImpl TransferServiceImpl(final AccountRepositoryImpl accountRepositoryImpl,
                                                   final TransactionRepositoryImpl transactionRepositoryImpl) {
        return new TransferServiceImpl(accountRepositoryImpl, transactionRepositoryImpl);
    }
}
